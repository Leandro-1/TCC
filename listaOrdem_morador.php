...
<div class="formulario w3-display-flex">
    <div class="w3-padding w3-margin w3-card-4 w3-cell">
        ...
        <table class="w3-table-all w3-centered  w3-cell" style="overflow-y:auto;">
            ...
            $sql = "SELECT morador.cpf, morador.nome, morador.telefone, morador.email, propriedade.num_propriedade, propriedade.bloco_quadra FROM morador, propriedade WHERE morador.id_propriedade = propriedade.id_propriedade order by $ordem";
